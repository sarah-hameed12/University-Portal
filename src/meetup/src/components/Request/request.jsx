...
// Import the images directly using JavaScript import syntax.
// Webpack/Vite will process these imports and provide correct URLs.
import iconRetinaUrl from 'leaflet/dist/images/marker-icon-2x.png';
import iconUrl from 'leaflet/dist/images/marker-icon.png';
import shadowUrl from 'leaflet/dist/images/marker-shadow.png';
import { set } from "mongoose";

// This part addresses an issue where Leaflet might still try to compute paths internally
...
const Create_Request = ({ close_func }) => {
    ...
    const initial_request = { name: "", place: "", time: "", purpose: "", group_size: "2" }
    ...
    const [pin_location, set_pin_location] = useState({lat:31.47 , lng:74.4111 })
    useEffect(()=>{
        set_form_data((old)=>{
            let a = "2"
    ...
    const handle_submit = (event) => {
        ...
        set_img(default_img)
        fetch("http://localhost:5001/upload_request", {
            method: "POST",
            headers: {
        ...
        <div className="request_background">
            <form onSubmit={handle_submit} className="request_form">
                <div className="images">
                    <img className="pic" src={curr_img} onClick={handle_click} alt="not found" />
                    <input
                        type="file"
                        ref={File_ref}
                        style={{ display: "none" }}
                ...
                <div className="form_text_fields">
                    ...
                    <label htmlFor="group_size"><strong>Group size: </strong></label>
                    <input
                        type="text"
                        id="group_size"
                        name="group_size"
                ...
                <div className="buttons">
                    <button onClick={close_func} type="button" className="cancel"> Go_back </button>
                    {(form_data.group_size !== "" && form_data.name !== "" && form_data.place !== "" && form_data.time !== "") ? (<button type="submit" className="submit">Submit</button>):
