...
function App() {
  ...
  return (
    <div className="App">
      {/* Pass active view state to Navbar */}
      <Navbar Navitems={items}/>

      {/* Wrap conditional components in a <main> tag */}
      <main className="main-content">
        ...
        {/* Placeholder when no specific component is visible */}
        {!is_prof_visible && !is_creating_request && !zoom && !myrequests && !has_interacted && !pastr && !accept && !upcoming && (
          <div className="main-content-placeholder">
            ...
            {/* Or render a default component like a dashboard/feed here */}
          </div>
        )}
      </main>
    </div>
