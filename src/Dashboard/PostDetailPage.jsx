...
const styles = {
  ...
  postActionButtonGroup: { display: "flex", gap: "25px" },
  postActionButton: {
    background: "none",
    border: "none",
    color: "#a0a3bd",
...
const CommentItem = ({
  ...
  const commentDeleteButtonStyle = {
    ...
    ...(hoveredDelete && styles.commentDeleteButton[":hover"]),
  };
  return (
    <>
      <motion.li
        ...
        <div style={styles.commentContentWrapper}>
          <div style={styles.commentHeader}>
            ...
            {canDelete && (
              ...
              >
                {isDeletingComment ? (
                  <div style={styles.commentDeleteButtonSpinner}></div>
                ) : (
                  <FiTrash2 size="1em" />
                )}
              </button>
...
const PostDetailPage = () => {
  ...
  const fetchPostAndComments = useCallback(async () => {
    ...
    try {
      const [postResponse, commentsResponse] = await Promise.all([
        ...
        axios.get(
          `https://flask-production-1e2d.up.railway.app/api/feed/posts/${postId}/comments/`
        ),
      ]);
    ...
    async (postIdToLike) => {
      ...
      try {
        const response = await axios.post(
          `https://flask-production-1e2d.up.railway.app/api/feed/posts/${postIdToLike}/like/`,
  ...
  const handleDeletePost = useCallback(
    async (postIdToDelete) => {
      ...
      try {
        await axios.delete(
          `https://flask-production-1e2d.up.railway.app/api/feed/posts/${postIdToDelete}/`,
          {
  ...
  const handleDeleteComment = useCallback(
    async (commentId) => {
      ...
      try {
        await axios.delete(
          `https://flask-production-1e2d.up.railway.app/api/feed/comments/${commentId}/`,
          {
            data: { user_id: currentUserId },
          }
        );
  ...
  const submitCommentButtonStyle = {
    ...
    ...(isSubmittingComment
      ...
      : styles.commentSubmitButtonHover),
  };
  ...
  const likeButtonStyle = {
    ...
    ...(isLiked && styles.postActionButtonLiked),
  };
