  ...
  const features = [
    {
      ...
      description: "Access to course outlines, documents, and study materials in a centralized location.",
      icon: <FiBook />,
    },
    {
      id: 2,
      title: "Chat System",
      description: "Real-time messaging with other students and faculty members for collaboration and support.",
      icon: <FiMessageSquare />,
    },
    {
      id: 3,
      title: "Schedule Management",
      description: "Organize your academic calendar, assignments, and deadlines with our intuitive scheduler.",
      icon: <FiCalendar />,
    },
    {
      id: 4,
      title: "Society Hub",
      description: "Discover and join student organizations, clubs, and events happening on campus.",
      icon: <FiUsers />,
    },
    {
      id: 5,
      title: "Academic Utilities",
      description: "Tools like GPA calculator, deadline tracker, and other resources to enhance your academic experience.",
      icon: <FiGrid />,
    },
  ];
    ...
    >
      ...
      <div style={styles.content}>
        <section style={styles.section}>
          ...
          >
            SuperLUMS is a comprehensive platform designed specifically for the LUMS community. Our mission is to 
            enhance the academic and social experience by providing tools that promote collaboration, organization, 
            and access to resources. We're committed to creating a more connected and efficient campus experience.
          </motion.p>
        </section>
          ...
          <div style={styles.featuresGrid}>
            {features.map((feature, index) => (
              <motion.div 
                ...
                style={{
                  ...styles.featureCard,
                  ...(hoveredFeature === feature.id ? styles.featureCardHover : {})
                }}
          ...
          <div style={styles.teamGrid}>
            {teamMembers.map((member, index) => (
              <motion.div 
                ...
                style={{
                  ...styles.teamCard,
                  ...(hoveredTeamCard === member.id ? styles.teamCardHover : {})
                }}
              ...
              >
                ...
                <div style={styles.socialLinks}>
                  <a 
                    ...
                    style={hoveredButton === `github-${member.id}` ? styles.socialIconHover : styles.socialIcon}
