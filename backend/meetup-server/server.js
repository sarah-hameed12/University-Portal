...
// app.post("/upload_profile",upload.single("myfile"),(req,res)=>{
//     console.log("upload")
//     console.log(req.body)
//     console.log(req.file.id)
//     img_const = req.file.id
//     console.log(img_const)
...
//     user_model.findOne({ unique_id: img_const }).then((err, user) => {
//         if (err) {
...
//         const downloadstream = gfs.openDownloadStreamByName(img_const)
